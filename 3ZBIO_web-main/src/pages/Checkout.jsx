        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                <div className="lg:col-span-3">
                    ...
                    <form className="bg-slate-100 px-5 py-12 mt-12">
                        <div className="space-y-12">
                            ...
                            <div className="mt-6 flex items-center justify-end gap-x-6">
                                <button
                                    type="button"
                                    className='border-2 border-teal-500 rounded px-3 py-1 min-w-[120px] text-teal-500 font-medium hover:bg-teal-500 hover:text-white'
                                >
                                    Reset
                                </button>
                                <button
                                    type="submit"
                                    className="rounded-md  border-teal-500 hover:text-white px-3 py-2 text-sm font-semibold text-white bg-teal-500 hover:bg-[#022636] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                                >
                                    Add Address
                                </button>
                            </div>
                ...
                <div className="lg:col-span-2">
                    <div className="mx-auto mt-12 bg-slate-100 max-w-7xl px-2 sm:px-2 lg:px-12">
                        <div className="border-t border-gray-200 px-0 py-6 sm:px-0">
                            ...
                            <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                                ...
                                <div className="mt-6 flex justify-center text-center text-sm text-gray-500">
                                    <p>
                                        or{' '}
                                        <a href="#" className="font-medium text-teal-500 hover:text-[#022636]">
