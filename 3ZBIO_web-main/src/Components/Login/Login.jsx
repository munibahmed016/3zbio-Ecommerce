        ...
        <div className='mx-auto container p-20'>
            ...
            <div className='bg-slate-100 p-5 w-full max-w-sm mx-auto'>
                    ...
                    <form className='pt-6 flex flex-col gap-2' onSubmit={handleSubmit}>
                        ...
                        <button className='bg-[#277F58] hover:bg-[#1e6554] text-white px-6 py-2 w-full max-w-[150px] rounded-full hover:scale-110 transition-all mx-auto block mt-6'>Login</button>
